...
/**
 * <p>Java class for IfcActuatorTypeEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="IfcActuatorTypeEnum">
 ...
 * 
 */
@XmlType(name = "IfcActuatorTypeEnum")
@XmlEnum
public enum IfcActuatorTypeEnum {

    @XmlEnumValue("electricactuator")
    ELECTRICACTUATOR("electricactuator"),
    @XmlEnumValue("handoperatedactuator")
    HANDOPERATEDACTUATOR("handoperatedactuator"),
    @XmlEnumValue("hydraulicactuator")
    HYDRAULICACTUATOR("hydraulicactuator"),
    @XmlEnumValue("pneumaticactuator")
    PNEUMATICACTUATOR("pneumaticactuator"),
    @XmlEnumValue("thermostaticactuator")
    ...
    public static IfcActuatorTypeEnum fromValue(String v) {
        for (IfcActuatorTypeEnum c: IfcActuatorTypeEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
