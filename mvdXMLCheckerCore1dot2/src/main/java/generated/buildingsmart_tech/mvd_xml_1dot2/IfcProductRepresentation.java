...
/**
 * <p>Java class for IfcProductRepresentation complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="IfcProductRepresentation">
 *   &lt;complexContent>
 ...
 *                 &lt;sequence>
 *                   &lt;element ref="{https://standards.buildingsmart.org/IFC/RELEASE/IFC4/Add2TC1}IfcRepresentation" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *                 &lt;attribute ref="{https://standards.buildingsmart.org/IFC/RELEASE/IFC4/Add2TC1}itemType fixed="ifc:IfcRepresentation""/>
...
@XmlType(name = "IfcProductRepresentation", propOrder = {
    "representations"
})
@XmlSeeAlso({
    ...
    extends Entity
{
    ...
    @XmlElement(name = "Representations", required = true)
    protected IfcProductRepresentation.Representations representations;
     ...
     * @return
     *     possible object is
     *     {@link IfcProductRepresentation.Representations }
     *     
     */
    public IfcProductRepresentation.Representations getRepresentations() {
     ...
     *     
     */
    public void setRepresentations(IfcProductRepresentation.Representations value) {
    ...
    public static class Representations {
        ...
        @XmlElementRef(name = "IfcRepresentation", namespace = "https://standards.buildingsmart.org/IFC/RELEASE/IFC4/Add2TC1", type = JAXBElement.class)
        protected List<JAXBElement<? extends IfcRepresentation>> ifcRepresentation;
        ...
        /**
         * Gets the value of the ifcRepresentation property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the ifcRepresentation property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getIfcRepresentation().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<JAXBElement<? extends IfcRepresentation>> getIfcRepresentation() {
            if (ifcRepresentation == null) {
                ifcRepresentation = new ArrayList<JAXBElement<? extends IfcRepresentation>>();
            }
            return this.ifcRepresentation;
        }
