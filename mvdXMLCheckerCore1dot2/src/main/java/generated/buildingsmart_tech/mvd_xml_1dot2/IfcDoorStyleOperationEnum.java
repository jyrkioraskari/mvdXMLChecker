...
/**
 * <p>Java class for IfcDoorStyleOperationEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="IfcDoorStyleOperationEnum">
 ...
 * 
 */
@XmlType(name = "IfcDoorStyleOperationEnum")
@XmlEnum
public enum IfcDoorStyleOperationEnum {
    ...
    IfcDoorStyleOperationEnum(String v) {
        value = v;
    }
    ...
    public static IfcDoorStyleOperationEnum fromValue(String v) {
        for (IfcDoorStyleOperationEnum c: IfcDoorStyleOperationEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
