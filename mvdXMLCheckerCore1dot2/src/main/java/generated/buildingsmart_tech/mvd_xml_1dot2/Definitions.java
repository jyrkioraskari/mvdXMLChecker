...
@XmlType(name = "Definitions", namespace = "http://buildingsmart-tech.org/mvd/XML/1.2", propOrder = {
    "definition"
})
public class Definitions {
    ...
    public static class Definition {
        ...
        @XmlElement(name = "Body", namespace = "http://buildingsmart-tech.org/mvd/XML/1.2")
        protected Definitions.Definition.Body body;
        @XmlElement(name = "Link", namespace = "http://buildingsmart-tech.org/mvd/XML/1.2", nillable = true)
