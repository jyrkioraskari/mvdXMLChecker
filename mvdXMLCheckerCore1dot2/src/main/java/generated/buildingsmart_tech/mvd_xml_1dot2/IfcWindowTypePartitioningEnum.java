...
/**
 * <p>Java class for IfcWindowTypePartitioningEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="IfcWindowTypePartitioningEnum">
 ...
 * 
 */
@XmlType(name = "IfcWindowTypePartitioningEnum")
@XmlEnum
public enum IfcWindowTypePartitioningEnum {
    ...
    IfcWindowTypePartitioningEnum(String v) {
        value = v;
    }
    ...
    public static IfcWindowTypePartitioningEnum fromValue(String v) {
        for (IfcWindowTypePartitioningEnum c: IfcWindowTypePartitioningEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
