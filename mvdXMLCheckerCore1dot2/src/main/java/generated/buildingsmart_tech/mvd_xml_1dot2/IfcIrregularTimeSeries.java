...
/**
 * <p>Java class for IfcIrregularTimeSeries complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="IfcIrregularTimeSeries">
 *   &lt;complexContent>
 ...
 *                 &lt;sequence>
 *                   &lt;element ref="{https://standards.buildingsmart.org/IFC/RELEASE/IFC4/Add2TC1}IfcIrregularTimeSeriesValue" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *                 &lt;attribute ref="{https://standards.buildingsmart.org/IFC/RELEASE/IFC4/Add2TC1}itemType fixed="ifc:IfcIrregularTimeSeriesValue""/>
...
@XmlType(name = "IfcIrregularTimeSeries", propOrder = {
    "values"
})
    ...
    extends IfcTimeSeries
{
    ...
    protected IfcIrregularTimeSeries.Values values;
     ...
     * @return
     *     possible object is
     *     {@link IfcIrregularTimeSeries.Values }
     *     
     */
    public IfcIrregularTimeSeries.Values getValues() {
        return values;
    }
     ...
     *     
     */
    public void setValues(IfcIrregularTimeSeries.Values value) {
        this.values = value;
    }
    ...
    public static class Values {
        ...
        @XmlElement(name = "IfcIrregularTimeSeriesValue", required = true, nillable = true)
        protected List<IfcIrregularTimeSeriesValue> ifcIrregularTimeSeriesValue;
        ...
        /**
         * Gets the value of the ifcIrregularTimeSeriesValue property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the ifcIrregularTimeSeriesValue property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getIfcIrregularTimeSeriesValue().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link IfcIrregularTimeSeriesValue }
         * 
         * 
         */
        public List<IfcIrregularTimeSeriesValue> getIfcIrregularTimeSeriesValue() {
            if (ifcIrregularTimeSeriesValue == null) {
                ifcIrregularTimeSeriesValue = new ArrayList<IfcIrregularTimeSeriesValue>();
            }
            return this.ifcIrregularTimeSeriesValue;
        }
