...
/**
 * <p>Java class for IfcDuctFittingTypeEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="IfcDuctFittingTypeEnum">
 ...
 * 
 */
@XmlType(name = "IfcDuctFittingTypeEnum")
@XmlEnum
public enum IfcDuctFittingTypeEnum {
    ...
    IfcDuctFittingTypeEnum(String v) {
        value = v;
    }
    ...
    public static IfcDuctFittingTypeEnum fromValue(String v) {
        for (IfcDuctFittingTypeEnum c: IfcDuctFittingTypeEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
