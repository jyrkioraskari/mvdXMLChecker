...
public class MvdXMLv1dot2Check {
	 ...
	 * bimserver_ifcModel.fixInverseMismatches(); List<MVDConceptConstraint>
	 * constraints = mvdXML.getMVDConstraints();
	 * 
	 ...
	 * ifcFile.toFile()); issues.addAll(issuereport.getIssues()); }
	 * 
	 * return issues; }
	 */
}
