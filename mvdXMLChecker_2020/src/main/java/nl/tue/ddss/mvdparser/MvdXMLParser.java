...
import de.rwth_aachen.dc.mvdxml.xsd1_1.EntityRule;
import de.rwth_aachen.dc.mvdxml.xsd1_1.ModelView;
import de.rwth_aachen.dc.mvdxml.xsd1_1.ModelView.ExchangeRequirements.ExchangeRequirement;
import de.rwth_aachen.dc.mvdxml.xsd1_1.MvdXML;
import de.rwth_aachen.dc.mvdxml.xsd1_1.Requirements.Requirement;
...
public class MvdXMLParser {
	...
	public MvdXMLParser(String fileName) throws JAXBException {
		JAXBContext mvdXMLSchema = JAXBContext
				.newInstance("de.rwth_aachen.dc.mvdxml.xsd1_1");
	...
	public List<ConceptRoot> extractConceptRoots() throws JAXBException {
		MvdXML.Views views = this.mvdXML.getViews();
	...
	public List<ConceptTemplate> getTemplates() throws JAXBException {
		List<ConceptTemplate> conceptTemplates = this.mvdXML.getTemplates()
				.getConceptTemplate();
