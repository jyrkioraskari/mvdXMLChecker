...
import de.rwth_aachen.dc.mvdxml.xsd1_1.Definitions;
import de.rwth_aachen.dc.mvdxml.xsd1_1.Definitions.Definition;
...
public class IfcMVDConstraintChecker {
	...
	for (AbstractRule rule : rules) {
	    ...
	    /* DEPRECATED - are handled in template rules //FIXME
