...
public class mvdXMLv1_1Parser extends Parser {
	public static final String[] tokenNames = new String[] {
		...
		"OR", "RPAREN", "SIMPLEID", "STRING", "TRUE", "UNICODE_ESC", "UNKNOWN", 
		"WS", "XOR", "'+'", "'-'", "'.'", "'[Size]'", "'[Type]'", "'[Unique]'", 
		"'[Value]'", "'e'", "'reg'"
	};
	...
	public final void boolean_term() throws RecognitionException {
		try {
			...
			if ( (LA6_0==SIMPLEID||(LA6_0 >= 31 && LA6_0 <= 34)) ) {
				alt6=1;
			}
			...
			switch (alt6) {
				case 1 :
					...
					if ( (LA5_0==DIGIT||LA5_0==FALSE||LA5_0==INT||(LA5_0 >= STRING && LA5_0 <= TRUE)||LA5_0==UNKNOWN||(LA5_0 >= 28 && LA5_0 <= 29)||LA5_0==36) ) {
						alt5=1;
					}
		...
		try {
			...
			switch (alt9) {
				case 1 :
					// mvdXMLv1_1.g:25:29: '.'
					{
					match(input,30,FOLLOW_30_in_real_literal240); 
					}
					break;
	...
	public static final BitSet FOLLOW_boolean_term_in_boolean_expression27 = new BitSet(new long[]{0x0000000008080012L});
	public static final BitSet FOLLOW_logical_interconnection_in_boolean_expression30 = new BitSet(new long[]{0x0000000780210000L});
	public static final BitSet FOLLOW_boolean_term_in_boolean_expression32 = new BitSet(new long[]{0x0000000008080012L});
	public static final BitSet FOLLOW_parameter_in_boolean_term47 = new BitSet(new long[]{0x0000000780026640L});
	...
	public static final BitSet FOLLOW_operator_in_boolean_term62 = new BitSet(new long[]{0x0000001032E01120L});
	public static final BitSet FOLLOW_value_in_boolean_term66 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_parameter_in_boolean_term70 = new BitSet(new long[]{0x0000000780000002L});
	public static final BitSet FOLLOW_metric_in_boolean_term74 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LPAREN_in_boolean_term89 = new BitSet(new long[]{0x0000000780210000L});
	...
	public static final BitSet FOLLOW_set_in_real_literal229 = new BitSet(new long[]{0x0000000840001022L});
	public static final BitSet FOLLOW_30_in_real_literal240 = new BitSet(new long[]{0x0000000800001022L});
	public static final BitSet FOLLOW_35_in_real_literal261 = new BitSet(new long[]{0x0000000030001020L});
