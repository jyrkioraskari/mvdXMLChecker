...
public class IfcGeomServerClient implements AutoCloseable {
	...
	void read_contents(LittleEndianDataInputStream s0) throws IOException {
	    ...
	    entity = new IfcGeomServerClientEntity(s.readInt(), readString(s), readString(s), readString(s), s.readInt(), readDoubleArray(s), s.readInt(), readByteBuffer(s), readByteBuffer(s), readByteBuffer(s), readByteBuffer(s), readByteBuffer(s),
		    readRemainder(bis));
	}
